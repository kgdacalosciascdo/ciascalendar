-- Keep former staff in historical calendar records while removing inactive accounts
-- from current employee selection and recurring birthday entries.
begin;
